...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    ...
    ImVec4 imTint(tintColor.r, tintColor.g, tintColor.b, tintColor.a);
    ImVec4 imBorder(borderColor.r, borderColor.g, borderColor.b, borderColor.a);
    ImGui::Image(textureID, imSize, ImVec2(0, 0), ImVec2(1, 1), imTint, imBorder);
}
...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    ...
    ImVec4 imTint(tintColor.r, tintColor.g, tintColor.b, tintColor.a);
    ImVec4 imBorder(borderColor.r, borderColor.g, borderColor.b, borderColor.a);
    ImGui::Image(textureID, imSize, uv0, uv1, imTint, imBorder);
}
...
void DrawLine(const sf::Vector2f& a, const sf::Vector2f& b,
    ...
    ImVec2 imA = ImVec2(a.x + pos.x, a.y + pos.x);
    ImVec2 imB = ImVec2(b.x + pos.x, b.y + pos.x);
    ImVec4 imColor(color.r, color.g, color.b, color.a);
    draw_list->AddLine(imA, imB, ColorConvertFloat4ToU32(imColor), thickness);
}
...
void DrawRect(const sf::FloatRect& rect, const sf::Color& color, float rounding,
    ...
    ImDrawList* draw_list = ImGui::GetWindowDrawList();
    ImVec4 imColor(color.r, color.g, color.b, color.a);
    draw_list->AddRect(getTopLeftAbsolute(rect), getDownRightAbsolute(rect), ColorConvertFloat4ToU32(imColor), rounding, rounding_corners, thickness);
}
...
void DrawRectFilled(const sf::FloatRect& rect, const sf::Color& color,
    ...
    draw_list->AddRectFilled(
        ...
        ColorConvertFloat4ToU32(imColor), rounding, rounding_corners);
}
...
bool imageButtonImpl(const sf::Texture& texture,
    ...
    ImVec2 imSize(size.x, size.y);
    ImVec4 imTint(tintColor.r, tintColor.g, tintColor.b, tintColor.a);
    ImVec4 imbgColor(bgColor.r, bgColor.g, bgColor.b, bgColor.a);
    return ImGui::ImageButton(textureID, imSize, uv0, uv1, framePadding, imbgColor, imTint);
}
